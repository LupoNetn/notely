    ...
    <div className="flex items-start min-h-screen p-3 ">
      ...
      <div className="w-full p-3">
        ...
        <textarea
          ...
          className="w-full min-h-[300px] p-4 rounded-md  text-gray-700 outline-none resize-none
            border border-gray-200  focus:border-blue-200 transition"
        />

        {/* Save Button */}
        <div className="mt-6 flex justify-end">
          <button className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2 rounded-full font-medium shadow-md transition">
            Save
          </button>
        </div>
      </div>
