...
const Notes = () => {
  const sampleNotes = [
    ...
    { id: 3, title: "Shopping List", content: "Buy laptop, keyboard, mouse..." },
  ];
  ...
  return (
    <div className="p-6 relative">
      <header className="mb-6">
        ...
        <p className="text-gray-500 mt-1">A simple place to jot down your thoughts.</p>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {sampleNotes.map((note) => (
          ...
          >
            <h2 className="font-semibold text-lg text-gray-800 mb-2">{note.title}</h2>
